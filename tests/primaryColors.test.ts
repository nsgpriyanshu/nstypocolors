...
describe('nstypocolors logging functions', () => {
  ...
  test('logRed should print a message in red', () => {
    ...
    expect(consoleSpy).toHaveBeenCalledWith(`${COLORS.red}${message}${COLORS.reset}`)
  })
  ...
  test('logGreen should print a message in green', () => {
    ...
    expect(consoleSpy).toHaveBeenCalledWith(`${COLORS.green}${message}${COLORS.reset}`)
  })
  ...
  test('logPink should print a message in pink', () => {
    ...
    expect(consoleSpy).toHaveBeenCalledWith(`${COLORS.pink}${message}${COLORS.reset}`)
  })
  ...
  test('logYellow should print a message in yellow', () => {
    ...
    expect(consoleSpy).toHaveBeenCalledWith(`${COLORS.yellow}${message}${COLORS.reset}`)
  })
  ...
  test('logBlue should print a message in blue', () => {
    ...
    expect(consoleSpy).toHaveBeenCalledWith(`${COLORS.blue}${message}${COLORS.reset}`)
  })
  ...
  test('logMagenta should print a message in magenta', () => {
    ...
    expect(consoleSpy).toHaveBeenCalledWith(`${COLORS.magenta}${message}${COLORS.reset}`)
  })
  ...
  test('logCyan should print a message in cyan', () => {
    ...
    expect(consoleSpy).toHaveBeenCalledWith(`${COLORS.cyan}${message}${COLORS.reset}`)
  })
  ...
  test('logWhite should print a message in white', () => {
    ...
    expect(consoleSpy).toHaveBeenCalledWith(`${COLORS.white}${message}${COLORS.reset}`)
  })
  ...
  test('logblack should print a message in black', () => {
    ...
    expect(consoleSpy).toHaveBeenCalledWith(`${COLORS.black}${message}${COLORS.reset}`)
  })
